...
class SummaryViewModel: ObservableObject {
    ...
    private func createDefaultAchievements() {
        let defaultAchievements = [
            ("First Task", "Complete your first task", "checkmark.circle"),
            ("Task Master", "Complete 5 tasks in one day", "star.fill"),
            ("Week Warrior", "Complete habits for 7 days straight", "flame.fill"),
            ("Consistent", "Use app for 7 days", "calendar"),
            ("Organized", "Create 10 tasks", "list.bullet")
        ]
        
        for (title, description, icon) in defaultAchievements {
    ...
    private func checkAndUnlockAchievements() {
        ...
        do {
            ...
            if completedTasks.count >= 1 {
                unlockAchievement(withTitle: "First Task")
            }
            ...
            if todayTasks.count >= 5 {
                unlockAchievement(withTitle: "Task Master")
            }
            ...
            if allTasks.count >= 10 {
                unlockAchievement(withTitle: "Organized")
            }
